...
class WorkflowOperationKind(StrEnum):
    ...
    PARTIAL_REVIEW_CHECK_HANDOFF = "partial-review-check-handoff"
    PARTIAL_QUALIFICATION_PREPARE = "partial-qualification-prepare"
    PARTIAL_QUALIFICATION_RUN = "partial-qualification-run"
    PARTIAL_QUALIFICATION_EVALUATE = "partial-qualification-evaluate"
