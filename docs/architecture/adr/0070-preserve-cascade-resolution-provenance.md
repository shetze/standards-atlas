# ADR 0070: Preserve cascade resolution provenance

## Status

Accepted

Administrative note: this record was originally committed with the duplicate number 0056.
It was renumbered to 0070 during documentation consolidation; the decision itself is unchanged.
