...
This model implements ADR 0007 and replaces the former `Clause.semantic_roles` representation removed by ADR 0008. No compatibility field exists in the clause model.
