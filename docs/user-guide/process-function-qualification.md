...
Canonical `EngineeringDocument`, knowledge-adoption, and AtlasData enrichment contracts use
schema **1** after the clean break. The qualification archive layout remains an independent
contract and is not changed by this persistence refactoring.
